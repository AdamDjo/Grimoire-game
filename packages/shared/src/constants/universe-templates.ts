...
export const UNIVERSE_TEMPLATES: UniverseTemplate[] = [
  {
    type: "fantasy",
    name: { en: "Velkhar", fr: "Velkhar" },
    description: {
      en: "A dark fantasy desert where artefacts corrupt, the Cendre spreads, and every run leaves a trace.",
      fr: "Un désert dark fantasy où les artefacts corrompent, la Cendre avance et chaque run laisse une trace.",
    },
    icon: "🏜️",
    primaryResource: { en: "Calamine", fr: "Calamine" },
    secondaryResource: { en: "Gold", fr: "Or" },
    themes: [
      { en: "Cendre", fr: "Cendre" },
      { en: "artefacts", fr: "artefacts" },
      { en: "survival", fr: "survie" },
      { en: "Souvenirs", fr: "Souvenirs" },
      { en: "The Blind One", fr: "L’Aveugle" },
    ],
  ...
  },
  {
    ...
    themes: [{ en: "customizable", fr: "personnalisable" }],
    defaultFactionCount: 3,
    defaultRegionCount: 4,
  },
];

export const getUniverseTemplate = (
  type: UniverseType,
): UniverseTemplate | undefined => {
